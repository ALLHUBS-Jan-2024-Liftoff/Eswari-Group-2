...
//                                "/gitartsy/api/artworks/**", "/uploads/**","/gitartsy/api/tags/**","/api/user/**",
//                                "/gitartsy/api/profiles/**", "/gitartsy/api/profiles/profileid/**", "/gitartsy/api/**", "/gitartsy/api/commissions/**").permitAll()
